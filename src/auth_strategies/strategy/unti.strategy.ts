...
export class UntiStrategy extends PassportStrategy(Strategy, 'unti') {
  constructor(private readonly configService: ConfigService) {
    super({
      ...
      authorizationURL: `https://sso.2035.university/oauth2/authorize?client_id=${configService.get('UNTI_CLIENT_ID')}&redirect_uri=${configService.get('UNTI_CLIENT_REDIRECT')}&response_type=code`,
