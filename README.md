...
- приводим auth к persons (create tokens in grants, del login controller/resolver)
...
В системе могут быть участники, зарегистрированные администратором или другими пользователями.
...
Для таких участников предусмотрена отдельная сущность - персоны или персонажи.
