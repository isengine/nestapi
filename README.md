...
Предполагается, что клиентское приложение уже создано и у имеет все необходимые права. Однако, если это не так, нужно сначала проверить и выполнить недостающие шаги из этого списка:
