...
- auth.dto нужен теперь или перенести его в формы? по крайней мере теперь он отвечает только за выходные данные, хотя нет, если говорить за изменение данных, то и за входящие, хотя опять же у нас нет прямого изменения данных для учетных данных
...
- snakeCase в именах файлов в auth, oauth
