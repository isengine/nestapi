...
Связи передаются в аргументе **relations**.
...
Для этого мы выделили отдельную таблицу **session**.
...
Для истории сессий мы сделали отдельную сущность **session** со своими методами.
