...
Возможно, на перенос в стратегии:
...
Пользователь открывает клиентское приложение и, например, открывает личный кабинет.
...
Также естественно, что клиентское приложение зарегистрировано в системе и у него есть все необходимые права.
...
Предполагается, что клиент уже зарегистрирован на сервере. Как это сделать, описано в другом разделе.
