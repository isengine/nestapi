...
- **strategy** - данные сторонних стратегий авторизации,
...
Также этот механизм можно использовать в качестве друхфакторной аутентификации.

Если вы хотите узнать подробнее, вам нужно смотреть раздел подтверждения.
...
Для генерации кода подтверждения, вы можете использовать uuid или методы рандомайзера.

> Обратите внимание, код подтверждения хранится в виде строки!

> Каждый код должен быть уникальным.

Например, после генерации можно проверять существование данного кода в таблице **confirm**, и если он повторяется, генерируется новый код.
